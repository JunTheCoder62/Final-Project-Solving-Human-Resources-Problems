...
Original file is located at
    https://colab.research.google.com/drive/1lm2soIkzZV53G6MpY_ZlJujhQLIEQjJv
...
output_file_name = 'cleaned_preprocessed_employee_data.csv'
df.to_csv(output_file_name, index=False)

from google.colab import files
files.download(output_file_name)

print(f"Data yang sudah dibersihkan dan dipreproses telah disimpan ke {output_file_name} dan siap diunduh.")
